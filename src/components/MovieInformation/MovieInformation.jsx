...
const MovieInformation = () => {
    ...
    return (
        <Grid container className={classes.containerSpaceAround}>
            <Grid item sm={12} md={6} lg={4} style={{display: 'flex', alignItems: 'flex-start', marginBottom: '30px',}}>
                <img
            ...
            <Grid item container direction='column' lg={7}>
                ...
                <Grid item className={classes.containerSpaceAround}>
                    <Box display='flex' align='center'>
                        ...
                        <Typography variant='subtitle1' gutterBottom style={{maringLeft: '10px'}}>
                ...
                <Grid item className={classes.genresContainer}>
                    {data?.genres?.map((genre) => (
                        <Link key={genre.name} className={classes.links} to='/' onClick={() => dispatch(selectGenreOrCategory(genre.id))}>
                            <img src={genreIcons[genre.name.toLowerCase()]} className={classes.genereImage} height={30}/>
                ...
                <Typography variant='h5' gutterBottom style={{maringTop: '10px'}}>
                    Overview
                </Typography>
